document.addEventListener("DOMContentLoaded", function () {
    ...
    document.addEventListener('click', function (e) {
     ...
     const favoritos = [
        { nome: "Thor", descricao: "Thor é muito protetor e cuida da casa com dedicação.", idade: "2 anos", raca: "Pastor Alemão", codigo: "C0001", imagem: "imagens/pet1.jpg" },
        { nome: "Mia", descricao: "Mia adora um bom carinho no colo e tem muita energia.", idade: "1 ano", raca: "Gato Siamês", codigo: "G0002", imagem: "imagens/pet6.png" }
    ];
